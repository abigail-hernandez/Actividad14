...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.rvwNews.adapter = NoticiaAdapter(getNews(), onNoticiaClicked = { noticia ->
            Toast.makeText(this, "Clic en: ${noticia.title}", Toast.LENGTH_SHORT).show() })
    }
    ...
    fun getNews(): List<Noticia>{
        ...
        for(i in 1..50){
            noticias.add(Noticia("Titulo $i", "Descripción $i"))
        }
